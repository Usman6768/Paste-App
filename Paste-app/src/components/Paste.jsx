...
import { FormatDate } from "../utliss/FormatDate";
  ...
  return (
    <div className="w-full h-full py-10 max-w-[1200px] mx-auto px-5 lg:px-0">
      <div className="flex flex-col gap-y-3">
        {/* Search */}
        <div className="w-full flex gap-3 px-4 py-2  rounded-[0.3rem] border border-[rgba(128,121,121,0.3)]  mt-6 text-white">
          <input
            type="search"
            ...
            {filteredPastes.length > 0 ? (
              filteredPastes.map((paste) => (
                ...
                >
                  ...
                  <div className="w-[10%] flex flex-col space-y-3">
                    <p className="text-4xl font-semibold text-white">{paste?.title}</p>
                    <p className="text-sm font-normal  text-[#c4c4c4]">
                      {paste?.content}
                    </p>
                  </div>
